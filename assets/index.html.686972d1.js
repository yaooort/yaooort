...
</code></pre></div><h3 id="\u914D\u7F6E\u6587\u4EF6" tabindex="-1"><a class="header-anchor" href="#\u914D\u7F6E\u6587\u4EF6" aria-hidden="true">#</a> \u914D\u7F6E\u6587\u4EF6</h3><p>\u4E3A\u9AD8\u7EA7\u6253\u5305\u914D\u7F6E\u6240\u9700\u7684\u6587\u4EF6\uFF1A</p><ul><li><p>macOS:</p><ul><li><p>\u5982\u679C\u6253\u5305DMG\u5B89\u88C5\u5305\uFF1A<code>macos/packaging/dmg/make_config.yaml</code></p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token key atrule">title</span><span class="token punctuation">:</span> \u5E94\u7528\u540D\u79F0
...
</code></pre></div></li><li><p>\u5982\u679C\u6253\u5305PKG\u5B89\u88C5\u5305\uFF1A<code>macos/packaging/pkg/make_config.yaml</code></p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token key atrule">install-path</span><span class="token punctuation">:</span> /Applications
...
</code></pre></div></li></ul></li><li><p>Windows:</p><ul><li><p>\u5982\u679C\u6253\u5305exe\u5B89\u88C5\u5305\uFF1A<code>windows/packaging/exe/inno_setup.sas</code></p><div class="language-SAS ext-SAS"><pre class="language-SAS"><code>[Setup]
AppId={{APP_ID}}
...
</code></pre></div></li><li><p>\u5982\u679C\u6253\u5305msix <code>windows/packaging/msix/make_config.yaml</code></p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token key atrule">display_name</span><span class="token punctuation">:</span> \u5E94\u7528\u540D\u79F0
